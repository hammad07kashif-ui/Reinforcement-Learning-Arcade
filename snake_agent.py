...
class Agent:
    def __init__(self):
        ...
        if os.path.exists('./model/snake_model.pth'):
            try:
                self.model.load_state_dict(torch.load('./model/snake_model.pth'))
                self.n_games = 100 
                self.model.eval()
